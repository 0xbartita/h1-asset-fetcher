#!/usr/bin/env python3
"""
APK Bulk Downloader - by 0xbartita
...
def main():
    parser = argparse.ArgumentParser(description="APK Bulk Downloader - by 0xbartita")
    ...
    print("  \033[96m║\033[93m         APK Bulk Downloader  |  by 0xbartita              \033[96m║\033[0m")
