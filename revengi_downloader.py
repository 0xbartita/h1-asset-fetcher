...
async def main():
    parser = argparse.ArgumentParser(description="RevEngiBot APK Downloader")
    ...
    print("  \033[96m║\033[93m     RevEngiBot APK Downloader             \033[96m║\033[0m")
